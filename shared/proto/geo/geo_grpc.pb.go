...
func (c *geospatialServiceClient) CalculateDistance(ctx context.Context, in *DistanceRequest, opts ...grpc.CallOption) (*DistanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, GeospatialService_CalculateDistance_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *geospatialServiceClient) CalculateETA(ctx context.Context, in *ETARequest, opts ...grpc.CallOption) (*ETAResponse, error) {
	out := new(ETAResponse)
	err := c.cc.Invoke(ctx, GeospatialService_CalculateETA_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *geospatialServiceClient) FindNearbyDrivers(ctx context.Context, in *NearbyDriversRequest, opts ...grpc.CallOption) (*NearbyDriversResponse, error) {
	...
	err := c.cc.Invoke(ctx, GeospatialService_FindNearbyDrivers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *geospatialServiceClient) UpdateDriverLocation(ctx context.Context, in *UpdateDriverLocationRequest, opts ...grpc.CallOption) (*UpdateDriverLocationResponse, error) {
	...
	err := c.cc.Invoke(ctx, GeospatialService_UpdateDriverLocation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *geospatialServiceClient) GenerateGeohash(ctx context.Context, in *GeohashRequest, opts ...grpc.CallOption) (*GeohashResponse, error) {
	...
	err := c.cc.Invoke(ctx, GeospatialService_GenerateGeohash_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *geospatialServiceClient) OptimizeRoute(ctx context.Context, in *RouteOptimizationRequest, opts ...grpc.CallOption) (*RouteOptimizationResponse, error) {
	...
	err := c.cc.Invoke(ctx, GeospatialService_OptimizeRoute_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedGeospatialServiceServer must be embedded to have forward compatible implementations.
