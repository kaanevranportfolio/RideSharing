...
func (x *GetMatchingStatsResponse) Reset() {
	*x = GetMatchingStatsResponse{}
	mi := &file_matching_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetMatchingStatsResponse) Descriptor() ([]byte, []int) {
	return file_matching_proto_rawDescGZIP(), []int{22}
}
...
const file_matching_proto_rawDesc = "" +
	"\n" +
	"\x0ematching.proto\x12\bmatching\x1a\x1fgoogle/protobuf/timestamp.proto\"^\n" +
	"\bLocation\x12\x1a\n" +
...
var file_matching_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
